...
struct Matrix3x3
{
	...
	Matrix3x3(const glm::mat3& matrix)
		...
		_10(matrix[0][1]), _11(matrix[1][1]), _12(matrix[2][1]),
		_20(matrix[0][2]), _21(matrix[1][2]), _22(matrix[2][2])
	{
...
struct Matrix4x4
{
	...
	Matrix4x4(const glm::mat4& matrix)
		...
		_10(matrix[0][1]), _11(matrix[1][1]), _12(matrix[2][1]), _13(matrix[3][1]),
		_20(matrix[0][2]), _21(matrix[1][2]), _22(matrix[2][2]), _23(matrix[3][2]),
		_30(matrix[0][3]), _31(matrix[1][3]), _32(matrix[2][3]), _33(matrix[3][3])
	{
